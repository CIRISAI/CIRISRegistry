#!/usr/bin/env python3
r"""
Human-first reader edition of the CEG spec -> ceg-1.0-rc12-reader.pdf.
...
lineage) stays in the source tree and in pdf/ceg-1.0-rc12.pdf.
"""
import re
...
(with full lineage) is the markdown source and \texttt{ceg-1.0-rc12.pdf}. Conformance is
...
if __name__ == "__main__":
    ...
    (D/"ceg-1.0-rc12-reader.tex").write_text("\n".join(body), encoding="utf-8")
    print(f"wrote ceg-1.0-rc12-reader.tex ({len(FILES)} files, §16 + RC1 register + changelog wall stripped)")
