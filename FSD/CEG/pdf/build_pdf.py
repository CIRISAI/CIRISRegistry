#!/usr/bin/env python3
"""Assemble an exhaustively-complete CEG 1.0-RC15 PDF from the markdown spec.
...
''' + nuc_lines + r'''
\title{\textbf{CEG --- The CIRIS Epistemic Grammar}\\[4pt]\large Version 1.0-RC15 (Release Candidate --- wire surface frozen) --- Exhaustively Complete Reference\\[2pt]\normalsize with the PQC Streaming Bandwidth/Lag Model}
\author{CIRIS Federation --- generated from \texttt{FSD/CEG/}}
\date{2026-06-15}
\begin{document}
\maketitle
\begin{abstract}\noindent
This document is the complete CEG 1.0-RC15 wire-format specification (the 1+4
...
if __name__ == "__main__":
    ...
    (D/'ceg-1.0-rc15.tex').write_text('\n'.join(body), encoding='utf-8')
    print('wrote ceg-1.0-rc15.tex (%d files)' % len(FILES))
