...
\normalsize\mdseries Version 0.17 --- Reader Edition\\[2pt]
...
\textbf{Version}: 0.17 (Public Working Draft)
...
\begin{quote}\itshape \textbf{Human-reading edition:} \texttt{pdf/ceg-0.17-reader.pdf} is the de-editorialized, deduplicated, human-first cut (version history, per-path narrative, and provenance cross-refs stripped). This source tree remains the canonical working draft and retains that lineage.\end{quote}
